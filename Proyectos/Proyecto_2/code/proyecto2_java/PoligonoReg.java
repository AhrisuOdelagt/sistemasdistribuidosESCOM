...
// Importamos los ArrayList para almacenar las coordenadas
import java.util.*;
...
public class PoligonoReg {
	...
	public PoligonoReg(int numVert, double radio) {
		...
		for(int i = 0; i < numVert; i++) {
			// Seguimos la fórmula para polígonos inscritos en una circunferencia
		...
		// Encontramos el área del polígono (1/2 * perimetro * apotema)
