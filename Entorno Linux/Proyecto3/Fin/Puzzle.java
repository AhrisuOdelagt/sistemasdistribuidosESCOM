...
// Clase para retratar a los rompecabezas en cada uno de sus estados
import java.util.ArrayList;
class Puzzle {
	/* Atributos */
	private ArrayList<Integer> contenido = new ArrayList<Integer>();	// Contenido actual del puzzle
	private ArrayList<Integer> estadoFin = new ArrayList<Integer>();	// Estado final del puzzle
	private int estado = 0;    // Estado de resolución (0 - inicio, 1 - en resolución) [Atributo en desuso]
	private int costoHeuristico = 0;    // Costo heurístico del puzzle (determina cuán factible es tomarlo como siguiente movimiento)
	
	/* Constructor */
	public Puzzle(ArrayList<Integer> content, int state, ArrayList<Integer> end) {
		// Creamos el Puzzle según las especificaciones dadas
	...
	// Cálculo del costo heurístico del puzzle y así determinar su factibilidad
