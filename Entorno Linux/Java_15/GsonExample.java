/*
Descargar el JAR de Gson y posteriormente:
Compilar con:
javac -cp ./gson-2.10.1.jar GsonExample.java
javac -cp ruta/al/archivo.jar MiArchivo.java
Ejecutar con:
java -cp .:./gson-2.10.1.jar GsonExample
java -cp .:ruta/al/archivo.jar MiClasePrincipal
*/
